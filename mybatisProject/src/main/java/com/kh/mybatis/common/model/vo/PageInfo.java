...
public class PageInfo {
	...
	private int maxPage; //마지막 페이지 수(총 페이지 수) (listCount, boardLimit의 영향 받음)
	private int startPage; // 페이징바의 시작 수(pageLimit, currentPage의 영향을 받음)
	private int endPage; // 페이징바의 끝 수(startPage, pageLimit의 영향을 받음)
